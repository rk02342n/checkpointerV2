...
import { Maximize2, Minimize2, Check, Clock, Pencil, CalendarHeart, ConciergeBell, ListPlus, ExternalLink, ChevronLeft, ChevronRight } from "lucide-react";
...
function GameView () {
    ...
    // Load more state (lifted so review submission can reset it)
